/* v39 — BVH4 Unified — Launch Config Optimized
 *
 * Changes from v38:
 *   - Optimal block count: 640 blocks of 256 threads (was 320)
 *   - +4% at 100K (1115 vs 1073), +2-3% at larger scenes
 *   - Woop triangles DEAD END: 55-70% slower (SoA MT wins on SIMT cache)
 *   - 128-thread blocks no improvement (compute-bound, not occupancy-limited)
 *   - CUB GPU radix sort included (from v38)
 *
 * Best results: 1115/958/852/784 MR/s @ 100K/500K/1M/2M diffuse
 * vs OptiX 8.1: +102%/+185%/+192% (551/336/292)
 */
